...
function twentytwenty_register_styles() {
	...
	// Add print CSS.
	wp_enqueue_style( 'twentytwenty-print-style', get_template_directory_uri() . '/assets/css/templatemo-edu-meeting.css', null, $theme_version, 'print' );
...
function twentytwenty_customize_preview_init() {
	...
	wp_enqueue_script( 'twentytwenty-customize-preview', get_theme_file_uri( '/assets/css/fontawesome.css' ), array( 'customize-preview', 'customize-selective-refresh', 'jquery' ), $theme_version, true );
